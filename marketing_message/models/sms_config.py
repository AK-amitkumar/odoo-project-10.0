...
class SmsConfig(models.Model):
    ...
    def get_default_info(self, fields):
        ...
        return {
            'account': Params.get_param('account', default=''),  # 253应用账号标识
            'password': Params.get_param('password', default=''),  # 253账号密码
            'host_sign': Params.get_param('host_sign', default=''),  # 253短信通知模板地址
            'host_marketing': Params.get_param('host_marketing', default=''),  # 253营销短信请求模板地址
            'sms_heard': Params.get_param('sms_heard', default=''),  # 253签名模板
        }
